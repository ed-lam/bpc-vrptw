...
// static inline void and_or_bitset(void* const bitset1,
//                                  const void* const bitset2,
//                                  const void* const bitset3,
//                                  const size_t size)
// {
//     for (size_t idx = 0; idx < size; ++idx)
//     {
//         reinterpret_cast<Byte*>(bitset1)[idx] =
//             (reinterpret_cast<Byte*>(bitset1)[idx] & reinterpret_cast<const Byte*>(bitset2)[idx]) |
//             reinterpret_cast<const Byte*>(bitset3)[idx];
//     }
// }
